...
const AUTHORNAME_MODNAME_DIR := "Abuzitin2000-MBTK" # Name of the directory that this file is in
const AUTHORNAME_MODNAME_LOG_NAME := "Abuzitin2000-MBTK" # Full ID of the mod (AuthorName-ModName)
...
func _ready() -> void:
	...
	var content_dir = "res://mods-unpacked/Abuzitin2000-MBTK/content_data/"
	var mod_log = "Abuzitin2000-MBTK"

	# Add content. These .tres files are ContentData resources
	ContentLoader.load_data(content_dir + "mbtk_contents.tres", mod_log)
...
func get_effect_behaviors() -> void:
	...
	player_effect_behaviors.append(load("res://mods-unpacked/Abuzitin2000-MBTK/content/effect_behaviors/mbtk_player_effect_behavior.tres"))
